...
`decode_one/` covers all three decoder error classes. `replay/` adds unknown and
invalid-size framed messages; it also receives all BinaryFILE error seeds.
...
- `build/fuzz/fuzz/corpus/decode_one`; and
