...
static_assert(all_messages::pipeline_metadata::generator_version == std::string_view{"0.6.0"});
static_assert(order_events::pipeline_metadata::generator_version == std::string_view{"0.6.0"});
