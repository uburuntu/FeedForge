...
static_assert(all_messages::pipeline_metadata::required_runtime_api_epoch == std::uint32_t{1U});
...
static_assert(all_messages::pipeline_metadata::generator_version == std::string_view{"0.5.0"});
static_assert(order_events::pipeline_metadata::generator_version == std::string_view{"0.5.0"});
